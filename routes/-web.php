...
//EEListController
Route::prefix('/ee')->group(function () {
    Route::get('', 'EEListController@index');
    //Route::get('idx', 'EEListController@idx');
});

//EEInteController
Route::prefix('/eeinte')->group(function () {
    Route::get('', 'EEInteController@index');
    //Route::get('idx', 'EEListController@idx');
});
...
Route::prefix('/intepreke')->group(function () {
   ...
   Route::post('store_save', 'IntePrekeController@store_save');
});
...
Route::prefix('/inte')->group(function () {
    ...
    Route::get('pigult', 'InteController@pigult');
    Route::get('indexlv', 'InteController@indexlv');
    Route::get('indexee', 'InteController@indexee');
...
Route::prefix('/grazinimai')->group(function () {
    ...
    Route::post('sepa_LV2', 'GrazinimaiController@sepa_LV2');
    ...
    Route::get('grazinimai_ee', 'GrazinimaiController@grazinimai_ee');
    Route::post('sepa_EE', 'GrazinimaiController@sepa_EE');
    Route::post('store_EE', 'GrazinimaiController@store_EE');
});
