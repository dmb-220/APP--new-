      ...
      <card-component v-if="isjungta" title="Apyvarta" icon="account-multiple"> 
        ...
        <div  id="printMe">
          ...
          <template slot-scope="props">
            ...
            <b-table-column class="has-text-right" label="Prestahop"  field="unikalus">
                  {{ props.row.unikalus }}
            </b-table-column>
            ...
            <b-table-column :visible="rodo == 1 || rodo == 3 || rodo == 4" class="has-text-right" label="Pristatymas"  field="pristatymas">
                  {{ parseFloat(props.row.pristatymas).toFixed(2) }}
            </b-table-column>
            <b-table-column :visible="rodo == 1 || rodo == 3 || rodo == 4" class="has-text-right" label="Per banka, Eur"  field="">
