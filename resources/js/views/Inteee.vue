      ...
      <card-component v-if="isjungta" title="Apyvarta" icon="account-multiple"> 
        ...
        <div  id="printMe">
          ...
          <div class="has-text-centered is-size-5">
            <b>Internetinė parduotuvė ( INEE )</b>
          </div>
          ...
          default-sort="saskaitos_nr">
            ...
            <b-table-column class="has-text-right" label="Prestashop"  field="unikalus" v-slot="props">
                  {{ props.row.unikalus }}
            </b-table-column>
            ...
            <b-table-column :visible="rodo == 1 || rodo == 3" class="has-text-right" label="Pristatymas"  field="pristatymas" v-slot="props">
                  {{ parseFloat(props.row.pristatymas).toFixed(2) }}
            </b-table-column>
            <b-table-column :visible="rodo == 1 || rodo == 3" class="has-text-right" label="Per banka, Eur"  field="" v-slot="props">
